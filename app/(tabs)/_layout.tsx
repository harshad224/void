    ...
    >
      ...
      <Tabs.Screen
        ...
        options={{
          tabBarLabel: "Search",
          tabBarIcon: ({ focused }) => (
            <TouchableOpacity onPress={() => handleTabPress("assets")}>
              <Feather
                name="search"
                size={24}
                color={focused ? "black" : "gray"}
      ...
      <Tabs.Screen
        ...
        options={{
          tabBarLabel: "Account",
          tabBarIcon: ({ focused }) => (
            <TouchableOpacity onPress={() => handleTabPress("account")}>
              <AntDesign
                name="user"
                size={24}
                color={focused ? "black" : "gray"}
      ...
      <Tabs.Screen
        ...
        options={{
          tabBarLabel: "More",
          tabBarIcon: ({ focused }) => (
            <TouchableOpacity onPress={() => handleTabPress("more")}>
              <Feather
                name="more-vertical"
                size={24}
                color={focused ? "black" : "gray"}
